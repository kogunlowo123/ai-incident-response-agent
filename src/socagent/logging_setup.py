...
def configure_logging(level: str = "INFO", *, json_output: bool = True) -> None:
    """Configure the ``socagent`` logger tree.
...
def get_logger(name: str) -> logging.Logger:
    """Return a logger namespaced under ``socagent``."""
    return logging.getLogger(name if name.startswith("socagent") else f"socagent.{name}")
